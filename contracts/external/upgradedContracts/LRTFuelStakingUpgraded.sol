...
import {ILRTFuelStakingUpgraded} from "./ILRTFuelStakingUpgraded.sol";
 ...
 */
contract LRTFuelStakingUpgraded is
    Initializable,
    UUPSUpgradeable,
    ReentrancyGuardUpgradeable,
    ILRTFuelStakingUpgraded
{
    ...
    function setStakeCapacity(
        ...
        require(_stakeCapacity > 0, "LRTFuelStaking::Stake capacity not set");
    ...
    function unstake(uint16 index) external override {
        ...
        require(claimable > 0, "LRTFuelStaking::You do not have enough stake");
        ...
        emit LRTFuelUnStaked(msg.sender, index, claimable);
    }
